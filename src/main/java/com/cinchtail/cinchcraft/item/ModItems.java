...
public class ModItems {
    ...
    public static final RegistryObject<Item> NETHERITE_HORSE_ARMOR = ITEMS.register("netherite_horse_armor",
            () -> new HorseArmorItem(14, "netherite",
                    new Item.Properties().tab(ModCreativeModeTabItems.CINCHCRAFT_ITEMS_TAB).fireResistant().stacksTo(1)));
    ...
    public static final RegistryObject<Item> STALK = ITEMS.register("stalk",
            () -> new StalkItem(ModBlocks.STALK.get(),
                    new Item.Properties().tab(ModCreativeModeTabBlocks.CINCHCRAFT_BLOCK_TAB)));
    ...
    public static final RegistryObject<Item> NETHER_SALAD = ITEMS.register("nether_salad",
            () -> new BowlFoodItem(new Item.Properties().tab(ModCreativeModeTabItems.CINCHCRAFT_ITEMS_TAB).stacksTo(1).food(ModFoods.NETHER_SALAD)));
