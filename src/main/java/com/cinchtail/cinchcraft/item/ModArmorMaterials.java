...
public enum ModArmorMaterials implements ArmorMaterial {
    RUBY("ruby", 25, new int[]{2, 5, 7, 3}, 19, SoundEvents.ARMOR_EQUIP_DIAMOND,
            0F, 0.0F, () -> Ingredient.of(ModItems.RUBY.get())),

    EMERALD("emerald", 25, new int[]{1, 4, 6, 2}, 19, SoundEvents.ARMOR_EQUIP_DIAMOND,
            0F, 0.0F, () -> Ingredient.of(Items.EMERALD));
