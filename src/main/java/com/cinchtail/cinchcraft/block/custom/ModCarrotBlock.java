...
public class ModCarrotBlock extends net.minecraft.world.level.block.CarrotBlock {
    ...
    public ModCarrotBlock(BlockBehaviour.Properties p_51328_) {
        super(p_51328_);
    }

    @Override
    protected @NotNull ItemLike getBaseSeedId() {
        return ModItems.CARROT_SEEDS.get();
    }
