...
public class ModEvents {
    ...
    public static class ForgeEvents {
        ...
        @SubscribeEvent
        public static void MelonShearing(PlayerInteractEvent.RightClickBlock event, BlockHitResult blockHitResult, InteractionHand interactionHand) {
            ...
            if(itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
                if (block == Blocks.MELON) {
                    ...
                    itemstack.hurtAndBreak(1, player, (broadcastBreakEvent) -> {
                        broadcastBreakEvent.broadcastBreakEvent(interactionHand);
                    });
