...
public class ReplacedCarrotsBlock extends CropBlock {
    ...
    public ReplacedCarrotsBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }



    protected ItemLike getBaseSeedId() {return ModItems.CARROT_SEEDS.get();
    }
